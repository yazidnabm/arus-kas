...
<div class="card">
    <div class="card-body">
        <h5 class="card-title mb-3">Daftar Kas Keluar</h5>
            ...
            <table class="table align-middle">
                ...
                <tbody>
                    @forelse($data as $item)
                        ...
                        {{-- ================= MODAL EDIT ================= --}}
                        <div class="modal fade" id="modalEditKasKeluar{{ $item->id }}" tabindex="-1">
...
{{-- ================= MODAL TAMBAH ================= --}}
<div class="modal fade" id="modalTambahKasKeluar" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
